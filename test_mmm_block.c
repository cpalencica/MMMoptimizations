...
#define C   1216  /* constant term */

#define NUM_TESTS 13 /* Number of different sizes to test */
...
int main(int argc, char *argv[])
{
  ...
  printf("row_len, blocked ijk, ijk\n");
  {
    int i, j;
...
// textbook implementation of blocked matrix multiply
void block_mmm_ijk(matrix_ptr a, matrix_ptr b, matrix_ptr c, int block_size)
{
